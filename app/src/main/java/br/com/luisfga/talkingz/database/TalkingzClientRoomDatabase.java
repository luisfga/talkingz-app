...
import br.com.luisfga.talkingz.database.dao.DirectMessageDAO;
import br.com.luisfga.talkingz.database.dao.GroupDAO;
import br.com.luisfga.talkingz.database.entity.UserGroupJoin;
import br.com.luisfga.talkingz.database.entity.Group;
import br.com.luisfga.talkingz.database.entity.DirectMessage;
import br.com.luisfga.talkingz.database.entity.GroupMessage;
            ...
            synchronized (TalkingzClientRoomDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            TalkingzClientRoomDatabase.class, "talkingzclient_database")
                            .build();
                }
            }
        }
